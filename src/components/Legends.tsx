  ...
  render() {
    return (
      <ScatteringLegendRoot>
        <LegendElement>
          <ScatterElement
            style={{ width: 35 / 2, backgroundColor: SunYellow }}
          />
        ...
        <LegendElement>
          <ScatterElement
            style={{ width: 35 / 2, borderRadius: 0, backgroundColor: AirBlue }}
          />
          <LegendItem>Air molecule</LegendItem>
        </LegendElement>

        <LegendElement>
          <ScatterElement style={{ width: 35 / 2, backgroundColor: SunBlue }} />
          <LegendItem>short Wavelength</LegendItem>
        </LegendElement>

        <LegendElement>
          <ScatterElement style={{ width: 105 / 2, backgroundColor: SunRed }} />
