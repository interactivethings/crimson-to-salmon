    ...
    return (
      <SquareWrapper>
        {this.props.countries
          .sort((b, a) => a.PM10 - b.PM10)
          .map((country, i) => (
            <SquareElement
              key={i}
              style={{ backgroundColor: colorCountries(country.PM10) }}
            >
...
export class HighlightSwitzerland extends React.Component<{
  runAnimation: boolean;
}> {
  render() {
    return (
      <>
        <SquareElementHighlight
          style={{
