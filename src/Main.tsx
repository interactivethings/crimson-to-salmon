...
import {
  ...
  ScatteringPolluted,
  ScatteringRed
} from "./components/Scattering";
import {
  Country,
  TwentyCountries,
  HighlightSwitzerland
...
const Chapter1 = () => {
  const [target, isThingIntersecting] = useInView();
  ...
  return (
    <>
      ...
      <Chapter>
        <ParagraphAreaAir>
          <Paragraph>
            Air is made up of only five main gases: Nitrogen (N₂), Oxygen (O₂),
            Argon (Ar), and Carbon Dioxide (CO₂). Several other compounds, such
            as natural Ozone (O₃), are also present. Additionally, air contains
            a huge amount of water vapor.
          </Paragraph>
          <ParagraphAir>
            Scientists also refer to this pure and natural gas mixture as{" "}
            <TextHighlighters style={{ backgroundColor: AirBlue }}>
              «dry air».
            </TextHighlighters>
          </ParagraphAir>
        </ParagraphAreaAir>
  ...
  return (
    <>
      ...
      <Chapter>
        <ParagraphArea>
          <Paragraph>
            <TextHighlighters style={{ backgroundColor: SunYellow }}>
              Sunlight
            </TextHighlighters>
            , in contrast, is composed of a spectrum of colors, ranging from{" "}
            <TextHighlighters style={{ backgroundColor: SunBlue }}>
              short
            </TextHighlighters>{" "}
            wavelengths (~300 nm) which are perceived as purplish-blue, to{" "}
    ...
    <>
      ...
      <Chapter>
        <ParagraphAreaDaytime>
          <Paragraph>
            «Rayleigh scattering» describes the behaviour of moleclues in the
            atmosphere when interacting with incident light. This works better
            for smaller particles compared to the wavelength of the light, as{" "}
            <TextHighlighters style={{ backgroundColor: SunBlue }}>
              shorter
            </TextHighlighters>{" "}
            wavelengths scatter more effectively than{" "}
            <TextHighlighters style={{ backgroundColor: SunRed }}>
              longer
            </TextHighlighters>{" "}
            wavelengths.
          ...
          <ParagraphDaytime>
            <TextHighlighters style={{ backgroundColor: AirBlueLight }}>
              Air molecules
            </TextHighlighters>{" "}
            are closer in size to{" "}
            <TextHighlighters style={{ backgroundColor: SunBlue }}>
              short
            </TextHighlighters>{" "}
            wavelengths of violet and blue light. As a result, pure air scatters
            blue light three times more effectively than it does{" "}
            <TextHighlighters style={{ backgroundColor: SunRed }}>
              red light
            </TextHighlighters>{" "}
      ...
      <Chapter>
        <ParagraphArea>
          <Paragraph>
            ...
            takes a much longer path through the atmosphere. This results in
            more encounters with{" "}
            <TextHighlighters style={{ backgroundColor: AirBlueLight }}>
              air molecules
            </TextHighlighters>{" "}
            and thus, more scattering events of the{" "}
            <TextHighlighters style={{ backgroundColor: SunBlue }}>
              blue
            </TextHighlighters>{" "}
    ...
    <>
      ...
      <Chapter>
        <ParagraphAreaPolluted>
          <Paragraph>
            The particulate load of the atmosphere varies from place to place
            due to variations in local pollution sources. While natural sources
            of particles do exist, human-generated emissions locally can
            ...
            or «particulate matter» (PM10) of very small sizes (~10 µm = 0.01
            mm) in the air.
          </Paragraph>
          <ParagraphPolluted>
            Due to their size an composition, the fine particles increase the
            scattering and absorption of light in the atmosphere. This weakens
            the sunlight, imparting a more{" "}
            <TextHighlighters
              style={{ backgroundColor: AirRedDark, color: "white" }}
            >
              crimson
            </TextHighlighters>{" "}
            color to the evening sky.
          </ParagraphPolluted>
        </ParagraphAreaPolluted>
        <VisualizationMain>
          <VisualizationArea ref={target}>
...
const Chapter6 = (props: { data: Array<Country> }) => {
  ...
  console.log(isThingIntersecting);
  ...
  return (
    <>
      ...
      <Chapter>
        <ParagraphAreaGlobal>
          <Paragraph>
            Worldwide, the color of the evening sky can look quite different.
            Here you can see an approximation of that color for 20 different
            countries around the world. The color is based on the average value
            of{" "}
            <TextHighlighters
              style={{ backgroundColor: AirRedDark, color: "white" }}
            >
            ...
            measured in their large economic areas in 2016.
          </Paragraph>
        ...
        <VisualizationMain>
          <VisualizationArea>
            ...
            {isThingIntersecting && (
              <HighlightSwitzerland runAnimation={isThingIntersecting} />
            )}
          </VisualizationArea>
        </VisualizationMain>
      </Chapter>
...
const Chapter8 = (props: { detailMonthly: Array<Station> }) => {
  const [target, isThingIntersecting] = useInView();
  const [limitTarget, limitThingIntersecting] = useInView();
    ...
    <>
      ...
      <Chapter>
        <ParagraphAreaCheckpoints>
          <Paragraph>
            When applying this gradient to the range of daily values measured
            over the month at the three main measuring stations for{" "}
            <TextHighlighters
              style={{ backgroundColor: AirRedDark, color: "white" }}
            >
              fine particles
            </TextHighlighters>{" "}
            of the city of Zurich, the official daily limit values are quickly
            exceeded.
          </Paragraph>
          <ParagraphCheckpoints ref={limitTarget}>
            The daily limit value for{" "}
            <TextHighlighters
              style={{ backgroundColor: AirRedDark, color: "white" }}
            >
              fine particles
            ...
            than average data might suggest.
          </ParagraphCheckpoints>
        </ParagraphAreaCheckpoints>
        <VisualizationMain>
          <VisualizationArea ref={target}>
            {isThingIntersecting && (
              <Zurich
                Animation={isThingIntersecting}
                stations={props.detailMonthly}
              />
            )}
            {limitThingIntersecting && (
              <Limits
                triggerAnimation={limitThingIntersecting}
                stations={props.detailMonthly}
              />
            )}
          </VisualizationArea>
    ...
    <>
      ...
      <Chapter>
        <ParagraphAreaInitiatives>
          <Paragraph>
            The awareness of fine particle emissions is essential for all of us,
            as many of the processes emitting fine particles also cause
            greenhouse gases. This contributes to the causes of climate change,
            whose effects bring direct existential threats to every living
            being.
          </Paragraph>
          <ParagraphInitiatives>But all hope is not lost.</ParagraphInitiatives>
          <ParagraphInitiativesTwo>
            These are three promising initiatives that are addressing the issue
            of air pollution and climate change in a straightforward way to
