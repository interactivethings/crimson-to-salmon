    ...
    <>
      ...
      <Chapter>
        <ParagraphArea style={{ minHeight: "150vh" }}>
          <Paragraph>
            Air is made up of only five gases: Nitrogen (N₂), Oxygen (O₂), Argon
            (Ar), and Carbon Dioxide (CO₂). Several other compounds, such as
            natural Ozone (O₃), are also present.
          </Paragraph>
      ...
      <Chapter>
        <ParagraphArea>
          <Paragraph>
            ...
            , on the contrary, is composed of a spectrum of colors, ranging from{" "}
      ...
      <Chapter>
        <ParagraphArea style={{ minHeight: "182vh" }}>
          ...
          <Paragraph style={{ marginTop: "102vh" }}>
            ...
            wavelengths of violet and blue light. Therefore, pure air scatters
            them three times more effectively than it does{" "}
            <TextHighlighters style={{ backgroundColor: SunRed }}>
              red light
            </TextHighlighters>
            . This results in the{" "}
    ...
    <>
      ...
      <Chapter>
        <ParagraphArea>
          ...
          <Paragraph style={{ marginTop: "1.2rem" }}>
            Although red light scatters poorly, this long distance leads to its
            scattering. Due to that, evening light that reaches an observer is
            noticeably{" "}
            <TextHighlighters style={{ backgroundColor: SunRed }}>
              salmon
            </TextHighlighters>
  ...
  return (
    <>
      ...
      <Chapter>
        <ParagraphArea style={{ minHeight: "182vh" }}>
          <Paragraph>
            The compounds of air vary due to the constant burning of fossils by
            human kind. This leads to an increased emission of{" "}
            <TextHighlighters
              style={{ backgroundColor: AirRedDark, color: "white" }}
            >
              fine particles
            </TextHighlighters>{" "}
            (PM10) in very small sizes (~10 µm = 0.01 mm) into the air.
          </Paragraph>
          <Paragraph style={{ marginTop: "102vh" }}>
            Due to their size an composition, fine particles scatter the same
            way as natural{" "}
            <TextHighlighters style={{ backgroundColor: AirBlue }}>
              Nitrogen
            </TextHighlighters>{" "}
            ...
            would do — they scatter more red light. This leads to an intense{" "}
            <TextHighlighters
              style={{ backgroundColor: AirRedDark, color: "white" }}
            >
              crimson
      ...
      <Chapter>
        <ParagraphArea>
          <Paragraph>
            ...
            measured all across Switzerland creates a gradient of the different
  ...
  return (
    <>
      ...
      <Chapter>
        <ParagraphArea style={{ minHeight: "158vh" }}>
          <Paragraph>
            When applying this gradient to the monthly values of the three main
            ...
            of the city of Zurich, the official limit values are quickly
            exceeded.
          </Paragraph>
          <Paragraph style={{ marginTop: "118vh" }} ref={target}>
            With the limit value for{" "}
            <TextHighlighters
              style={{ backgroundColor: AirRedDark, color: "white" }}
            >
              fine particles
            </TextHighlighters>{" "}
            (PM10) being 20 µg / m3 per year, this plot of the monthly values
            show, that Zurich’s evening skies can actually be more{" "}
            <TextHighlighters
              style={{ backgroundColor: AirRedDark, color: "white" }}
            >
              «crimson»
        ...
        <VisualizationMain>
          <VisualizationArea ref={target}>
            ...
            {isThingIntersecting && (
              <Limits
                triggerAnimation={isThingIntersecting}
                stations={props.detailMonthly}
              />
            )}
          </VisualizationArea>
    ...
    <>
      ...
      <Chapter>
        <ParagraphArea style={{ minHeight: "180vh" }}>
          <Paragraph>
            The reduction of fine particle emissions is essential for all of us,
            as the year 2050 marks a point of no return for our climate. This
            means there is no way of reversing or stopping the effects of
            climate change, which will bring direct existential threats to every
            living being.
          </Paragraph>
